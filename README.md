...
1. Includes **additional** kexts (for ethernet, audio, etc);
2. Include the **necessary** ACPI patches (.aml);
3. Review the special notes;
4. Generate and complete your SMBIOS infos - **ALWAYS**;
5. Adjust your BIOS;
